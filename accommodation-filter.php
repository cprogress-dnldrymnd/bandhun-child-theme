 ...
 *  --------------------------------
 */
if (!class_exists('WeddingDir_Search_Result_Filter_Widget_Accommodation') && class_exists('WeddingDir_Search_Result_Helper')) {

    /**
     *  WeddingDir Search Listing Helper
     *  --------------------------------
     */
    class WeddingDir_Search_Result_Filter_Widget_Accommodation extends WeddingDir_Search_Result_Helper
    {
        ...
        public static function widget($args = [])
        {
            ...
            if (parent::_is_array($args)) {
                ...
                $_enable_widget        =   get_field(
                     ...
                     *  -----------
                     */
                    sanitize_key('overnight_accommodation_available'),
                ...
                $_have_lable    =   get_field(
                     ...
                     *  -----------
                     */
                    sanitize_key('overnight_accommodation_lable'),
                 ...
                 *  -------------
                 */
                $_checkbox_data     =    WeddingDir_Taxonomy::get_listing_overnight_accommodation(absint($cat_id));
        ...
        public static function active_filter($args = [])
        {
            ...
            $_style_list       =   WeddingDir_Taxonomy::get_listing_overnight_accommodation(parent::_cat_id());
        ...
        public static function widget_name()
        {
            ...
            return         esc_attr('listing-overnight-accommodation');
        }
    }
     ...
     *  --------------------
     */
    WeddingDir_Search_Result_Filter_Widget_Accommodation::get_instance();
}
