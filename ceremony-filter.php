 ...
 *  --------------------------------
 */
if (!class_exists('WeddingDir_Search_Result_Filter_Widget_Ceremony') && class_exists('WeddingDir_Search_Result_Helper')) {

    /**
     *  WeddingDir Search Listing Helper
     *  --------------------------------
     */
    class WeddingDir_Search_Result_Filter_Widget_Ceremony extends WeddingDir_Search_Result_Helper
    {
        ...
        public static function widget($args = [])
        {
            ...
            if (parent::_is_array($args)) {
                ...
                $_enable_widget        =   get_field(
                     ...
                     *  -----------
                     */
                    sanitize_key('ceremony_options_available'),
                ...
                $_have_lable    =   get_field(
                     ...
                     *  -----------
                     */
                    sanitize_key('ceremony_options_lable'),
                 ...
                 *  -------------
                 */
                $_checkbox_data     =    WeddingDir_Taxonomy::get_listing_overnight_ceremony_options(absint($cat_id));
        ...
        public static function active_filter($args = [])
        {
            ...
            $_style_list       =   WeddingDir_Taxonomy::get_listing_ceremony_options(parent::_cat_id());
        ...
        public static function widget_name()
        {
            ...
            return         esc_attr('listing-ceremony-options');
        }
    }
     ...
     *  --------------------
     */
    WeddingDir_Search_Result_Filter_Widget_Ceremony::get_instance();
}
