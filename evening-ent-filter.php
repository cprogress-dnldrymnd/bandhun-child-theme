 ...
 *  --------------------------------
 */
if (!class_exists('WeddingDir_Search_Result_Filter_Widget_Ent') && class_exists('WeddingDir_Search_Result_Helper')) {

    /**
     *  WeddingDir Search Listing Helper
     *  --------------------------------
     */
    class WeddingDir_Search_Result_Filter_Widget_Ent extends WeddingDir_Search_Result_Helper
    {
        ...
        public static function widget($args = [])
        {
            ...
            if (parent::_is_array($args)) {
                ...
                $_have_lable    =   get_field(
                     ...
                     *  -----------
                     */
                    sanitize_key('evening_entertainment_lable'),
                 ...
                 *  -------------
                 */
                $_checkbox_data     =    WeddingDir_Taxonomy::get_listing_ent(absint($cat_id));
        ...
        public static function active_filter($args = [])
        {
            ...
            $_style_list       =   WeddingDir_Taxonomy::get_listing_ent(parent::_cat_id());
     ...
     *  --------------------
     */
    WeddingDir_Search_Result_Filter_Widget_Ent::get_instance();
}
