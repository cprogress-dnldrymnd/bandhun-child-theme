...
/**
 *  WeddingDir Couple Add New Group Form
 *  ------------------------------------
 */
if (!class_exists('WeddingDir_Guest_List_Add_Menu') && class_exists('WeddingDir_Guest_List_Database')) {

    /**
     *  WeddingDir Couple Add New Group Form
     *  ------------------------------------
     */
    class WeddingDir_Guest_List_Add_Menu extends WeddingDir_Guest_List_Database
    {
...
?>
            ...
            <div id="weddingdir_guest_menu_sidepanel" class="sliding-panel">

                <div class="card-shadow-header mb-0">
                    <div class="dashboard-head">

                        <h3><?php esc_attr_e('Add Menu', 'weddingdir-guest-list'); ?></h3>
                ...
                <div class="card-shadow-body">
                    ...
                    <form id="weddingdir_guest_add_menu_form" method="post" autocomplete="off">
...
<?php
        ...
        public static function load_form()
        {
            ...
            printf(
                ...
                // 2
                esc_attr__('Add Menu', 'weddingdir-guest-list'),
     ...
     *  ---------------------------------------------------
     */
    WeddingDir_Guest_List_Add_Menu::get_instance();
}
