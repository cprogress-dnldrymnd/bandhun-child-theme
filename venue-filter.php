 ...
 *  --------------------------------
 */
if (!class_exists('WeddingDir_Search_Result_Filter_Widget_Facilities') && class_exists('WeddingDir_Search_Result_Helper')) {

    /**
     *  WeddingDir Search Listing Helper
     *  --------------------------------
     */
    class WeddingDir_Search_Result_Filter_Widget_Facilities extends WeddingDir_Search_Result_Helper
    {
        ...
        public static function widget($args = [])
        {
            ...
            if (parent::_is_array($args)) {
                ...
                $_enable_widget        =   get_field(
                     ...
                     *  -----------
                     */
                    sanitize_key('venue_facilities_options_available'),
                ...
                $_have_lable    =   get_field(
                     ...
                     *  -----------
                     */
                    sanitize_key('venue_facilities_options_lable'),
                 ...
                 *  -------------
                 */
                $_checkbox_data     =    WeddingDir_Taxonomy::get_venue_facilities(absint($cat_id));
        ...
        public static function active_filter($args = [])
        {
            ...
            $_style_list       =   WeddingDir_Taxonomy::get_venue_facilities(parent::_cat_id());
        ...
        public static function widget_name()
        {
            ...
            return         esc_attr('listing-venue-facilities-options');
        }
    }
     ...
     *  --------------------
     */
    WeddingDir_Search_Result_Filter_Widget_Facilities::get_instance();
}
